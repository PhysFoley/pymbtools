...
def main():
    ...
    # Set Up                                                    #
    #############################################################
    system = espressomd.System(box_l = [30.0,10.0,20.0]) #periodic BC by default
    ...
    uPos, dPos, uAngle, dAngle = buckledBilayer(system, 37., 318, verbose=True)
    
    ulipids = [Lipid(system,lipidType=typeA) for i in range(len(uPos))]
    dlipids = [Lipid(system,lipidType=typeB) for i in range(len(dPos))]
    ...
    system.non_bonded_inter[3, 3].lennard_jones_cos2.set_params(
            epsilon=lj_eps, sigma=btt,
            width=wc, offset=0.)
    
    system.non_bonded_inter[1, 2].lennard_jones_cos2.set_params(
            epsilon=lj_eps, sigma=btt,
            width=wc, offset=0.)
    
    system.non_bonded_inter[1, 3].lennard_jones_cos2.set_params(
            epsilon=lj_eps, sigma=btt,
            width=wc, offset=0.)
